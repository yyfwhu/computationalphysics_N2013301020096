...
class ELECTRIC_FIELD(object):
    def __init__(self,n=30, V1=1, V2=-1, V_boundary=0):
        self.V1=float(V1)
        self.V2=float(V2)
...
cmp=ELECTRIC_FIELD(5)
cmp.update_V_SOR()
cmp.plot_3d(ax1,-1.,1.,-1.,1.)
fig.colorbar(cmp.surf, shrink=0.5, aspect=5)

ax1= plt.subplot(2,2,2,projection='3d')
cmp=ELECTRIC_FIELD(10)
cmp.update_V_SOR()
cmp.plot_3d(ax1,-1.,1.,-1.,1.)
fig.colorbar(cmp.surf, shrink=0.5, aspect=5)

ax1= plt.subplot(2,2,3,projection='3d')
cmp=ELECTRIC_FIELD(15)
cmp.update_V_SOR()
cmp.plot_3d(ax1,-1.,1.,-1.,1.)
fig.colorbar(cmp.surf, shrink=0.5, aspect=5)

ax1= plt.subplot(2,2,4,projection='3d')
cmp=ELECTRIC_FIELD(30)
cmp.update_V_SOR()
cmp.plot_3d(ax1,-1.,1.,-1.,1.)
#fig.colorbar(cmp.surf, shrink=0.5, aspect=5)
'''
